...
def parser_(parser):
    ...
    parser.add_argument('--proto_consistW', type=float, default=0.0, help='loss weight for proto_consist')
    ...
    #short-term memory
    parser.add_argument("--fs", default=256, type=int, help="feature size")
    parser.add_argument("--queue_length", default=65536, type=int, help="length of short-term memory")
